...
<div class="hide">
	<p><a href="#content"><?php _e( 'Skip to content', 'simpl4' ); ?></a></p>
</div>
...
<div id="logo"> 
		...
		<?php if (get_theme_mod( 'simpl4_logo' ) !='') { ?>         
        <a href="<?php echo site_url(); ?>"><img id="mainlogo" src="<?php echo esc_url( get_theme_mod( 'simpl4_logo' ) ); ?>" alt="<?php bloginfo( 'name' ); ?>"></a>
		<?php } else { ?>
